...
#    Updated: 2024/03/18 15:55:27 by mohilali         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c parsing/ft_split_tokens.c parsing/labling.c parsing/debug.c parsing/new_expand_args.c parsing/check_syn.c parsing/combine_list.c parsing/helper.c \
	...
	builtins/env.c builtins/echo.c builtins/export.c builtins/builtins_helpers.c parsing/mask.c builtins/cd.c parsing/inheritance.c
