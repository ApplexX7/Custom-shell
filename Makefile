...
#    Updated: 2024/03/13 21:34:12 by mohilali         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c parsing/ft_split_tokens.c parsing/labling.c parsing/debug.c parsing/expand_args.c parsing/check_syn.c parsing/combine_list.c parsing/helper.c \
	parsing/labling_priority.c parsing/build_tree.c parsing/open_herdocs.c parsing/get_next_line.c parsing/helpers.c parsing/wildcard.c parsing/set_tree_io.c \
